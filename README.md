...
1. Point `ApiEndpoints.baseUrl` (`lib/core/network/api_endpoints.dart`) at the new backend.
2. Drop project assets into `assets/images/`, `assets/icons/`; add translation keys to `assets/translations/{en,ar}.json`.
